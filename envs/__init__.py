...
# register(
#     id='wlan-v0',
#     entry_point='gym.envs.wlan:ApEnv',
#     )
# register(
#     id='wlanmap-v0',
#     entry_point='gym.envs.wlan:MApEnv',
#     )
# wlan2ed
# --------
register(
    id='wlanmap-v0',
    entry_point='gym.envs.WLANPaper:MapEnv',
    )
# UAV
# --------
register(
    id='uav-downlink-v0',
    entry_point='gym.envs.UAV:Downlink',
    )
register(
    id='uav-downlink-2d-v0',
    entry_point='gym.envs.UAV:Downlink_2d',
    )
register(
    id='uav-downlink-2d-v3',
    entry_point='gym.envs.UAV:Downlink_2d_v3',
    )
register(
    id='uav-downlink-2d-v2',
    entry_point='gym.envs.UAV:Downlink_2d_v2',
    )